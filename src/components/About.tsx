  ...
  return (
    <section id="about" className="about mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
      ...
      <div className="content">
        <p className='mb-4'>Hello! I&apos;m Dev, an experienced software engineer who is passionate about shaping the future with data and technology. My journey began at the <a className="highlight" href="https://www.iitbhu.ac.in">IIT (BHU)</a>, in India, where I was introduced to NLP and Vision, igniting my love for data. I&apos;ve since explored diverse environments—from refining ML systems during an internship to enhancing software solutions at <a className="highlight" href="https://www.societegenerale.com/en">Societe Generale</a>. I&apos;m also a certified <a className="highlight" href="https://www.credly.com/badges/8c8b0b19-27f4-42db-8354-d390f0e60a27/linked_in_profile">Google Cloud Professional MLE</a>.
        </p><p className='mb-4'>Currently, I&apos;m studying Computer Science at <a className="highlight" href="https://www.tamu.edu">Texas A&M</a>, where I&apos;m deepening my expertise in the latest in AI and innovative software engineering. I&apos;m excited about leveraging these skills to tackle real-world challenges and create impactful solutions.
        </p><p className='mb-4'>
